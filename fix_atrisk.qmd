...
available_400476 <-
  available %>%
  filter(program_id_budget == "400476")
```
...
journal_1010212 <-
  jrnl_journal(
    needs_fix_1010212,
    budget = available_1010212, step = "1010212"
  )
```
...
journal_1010001 <-
  jrnl_journal(
    needs_fix_1010001,
    budget = available_1010001, step = "1010001"
  )
```
...
journal_400476 <-
  jrnl_journal(
    needs_fix_400476,
    budget = available_400476, step = "400476"
  )
```
